...
class TestScraperBasicFunctionality:
    ...
    def test_scraper_returns_list(self, mock_fetch, scraper_class, expected_name, mock_geocoding_service):
        """Test that scrape() returns a list."""
        # Mock failed fetch to avoid actual network calls
    ...
    @pytest.mark.parametrize("scraper_class,expected_name", SCRAPERS)
    @patch('src.scrapers.base.BaseScraper.fetch_page')
    def test_scraper_handles_empty_html(self, mock_fetch, scraper_class, expected_name, mock_geocoding_service):
